...
Usa esos prefijos según se requiera y aplica el concepto de marcar la definición de la refenencia con **\#** y su llamana con **\@**. Ve el ejemplo siguiente. Quiero incluir la definición de algo de interés (@def-definir - aquí use **\@def-definir** para hacer la llamada). Esta llamada hace referencia a esto, que puedo poner en cualquier lugar del documento.
