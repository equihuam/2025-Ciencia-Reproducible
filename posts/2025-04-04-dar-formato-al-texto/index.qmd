...
### cColor de la barra de avegación

El color de fondo del encabezado de las páginas del blog lo puedes especificar en el archivo _quarto.yml que tienes en el directorio raíz de tu proyecto. Sólo necesitas agregar la línea background: tu_color dentro del paquete de especificaciones de navbar. El color de los rótulos con foreground. Se ve algo así:
...
grViz(engine = "dot", 
  diagram =  "
      digraph DAG {
        ...
        # características generales del diagrama
