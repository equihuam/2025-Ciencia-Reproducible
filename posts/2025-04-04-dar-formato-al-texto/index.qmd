...
Por cierto, el componente *about* tiene sus propios estilos, pues se
...
[Otra
manera](https://quarto.org/docs/presentations/beamer.html#multiple-columns)
es la siguiente.

> ::: {.columns}
>
> :::: {.column width="40%"} Párrafo 1 con algunas ideas muy sabias....\
> ::::
>
> ::::{.colum width="60%" } Párrafo 2 para explicar lo sabio del párrafo
> 1....
>
> :::
