...
Los número dentro de paréntesis cuadrados indican proporción, no una magnitud absoluta. En este caso, dos columnas del mismo tamaño. Puedes usar valores negativos para indicar columnas vacías. El resultado se ve así:
...
Intenta usar esto para producir un [texto al lado de una imágen](https://quarto.org/docs/authoring/figures.html). ¿Con cuál variante sientes más cómoda o cómodo?
