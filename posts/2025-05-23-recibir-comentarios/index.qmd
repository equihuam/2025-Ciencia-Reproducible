...
La pequeña flecha arriba a la derecha abre el espacio de registro de los coentarios. Puedes notar que inicialmente los comentarios se registran en un _ambito_ **público**. Con objeto de que tengas algo más de control sobre el público con el que te interesa interactuar te sugiero usar grupos específicos que requieren invitación. Así, que el camino te llevará a registrarte en `hypothes.is` y desde tu cuenta generar los grupos y las invitaciones.
