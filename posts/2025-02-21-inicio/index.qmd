...
::: {layout="[1, 1.5]"}
![Libro de Irene Vallejo](images/900-el-infinito-en-un-junco-irene-vallejo-alfa.png){width="200px" #fig-junco}
...
![John Gruber](images/John_Gruber,_2009_(cropped) - By Randy Stewart, CC BY-SA 3.0, httpscommons.wikimedia.orgwindex.phpcurid=10682505.jpg){#fig-gruber width="200px"}
:::
...
![Linus Torvalds](images/Lf Asia-wikimedia- by the Archive Team-CC BY 3-.jpeg){#fig-torvalds width="80%"}
:::
