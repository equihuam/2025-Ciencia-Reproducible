...
URL_estaciones <- "https://api.datos.gob.mx/v2/sinaica-estaciones"
...
El dato que necesitamos en este caso es el **idEstación**, también el nombre del parámetro, en este caso **O3**. Hay un dato *pageSize*, que se refiere al máximo de registros que esperamos recibir por página. Con estos datos construimos la **URL** necesaria. 
