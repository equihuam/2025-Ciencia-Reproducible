...
En la construcción de documentos académicos las referencias bibliográficas son escenciales. Llevar el control de las que soportar tu trabajo, anotarlas en apoyo a tus argumentos y citarlas correctamente en una secciín de referencias es una tarea indispensbale. [*Quarto* te ofrece muchos recursos][quarto-citas] para realizar esto. Lo primero es agregar las opciones de bibliografía en la sección de encabezado del documento que estes trabajando. Una para especificar el archivo en el que estas recolectando tus datos bibliográficos (`*.bib`) y otra para controlar el *estilo* de presentación de las citas (`*.csl`). Existe el [**proyecto CSL**][csl-primer] que ha creado un [repositorio público][csl-styles] con más de 8,500 archivos de estilo (compartidos con una licencia de *Creative Commons*).
...
En este ejemplo, ambos archivos están en el mismo directorio del documento que estás trabajando. Si usas otra ubicación asegurate de proporcionar la información adecuada en la ruta de los archivos.
