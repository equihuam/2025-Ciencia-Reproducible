...
El camino es también sencillo, aunque tenxrpas que instalar la [biblioteca Microsoft365R](https://solutions.posit.co/connections/microsoft365/). Es una colección de herramientas muy potente para interactuar con la nube de Microsoft. Incluye capacidades para acceder y operar programáticamente _OneDrive_ (personal y profesional), _Sharepoint_ y _Outlook_. Una vez instalada la biblioteca podrás hacer esto.
...
archivo <- "M3-estadística/Datos/masa-para-pizza.txt"

# Autoriza el acceder a mi cuenta de OneDrive
