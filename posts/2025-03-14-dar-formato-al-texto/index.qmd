...
Otra cosa que puede interesarte hacer es controlar el arreglo general de la página de tu blog. Algo que puedes hacer en el encabezado **yml** de cada contribución que quieras o en el documento general `_quarto.yml`.
...
![](estructura-pagina.png){width="500"}
...
A veces conviene ofrecer información adicional al lector, dándole la oportunidad de decidir cuándo o si es que la desea ver. Hay una colección de cajas de este tipo en *Quarto* que se engloban en la conjunto [callout](https://quarto.org/docs/authoring/callouts.html). Su uso es mediante *fences* (**div**), el sistema de marcado que se inicia con `::: {_indicación_}` y se cierra con `:::`.
